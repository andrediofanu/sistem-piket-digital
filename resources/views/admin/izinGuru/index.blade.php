      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <!-- Email Input (from user's code) -->
              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Email address</label>
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
              </div>

              <!-- Searchable Dropdown (Applied to Example Select) -->
              <div class="mb-3">
                <label for="searchableSelectButton" class="form-label">Example select (Searchable)</label>
                <div class="dropdown">
                  <!-- The button that acts as the input field. Changed style to w-100 and text-start to look like a form control. -->
                  <button
                    class="btn btn-outline-secondary dropdown-toggle w-100 text-start d-flex align-items-center justify-content-between"
                    type="button" id="searchableSelectButton" data-bs-toggle="dropdown" aria-expanded="false"
                    data-selected-value="1">
                    <!-- This span holds the selected value text -->
                    <span id="selectedDisplay">1 (Option Alpha)</span>
                  </button>

                  <!-- The dropdown menu container -->
                  <ul class="dropdown-menu shadow" aria-labelledby="searchableSelectButton" id="searchableSelectMenu">
                    <!-- Search Input Section -->
                    <li class="dropdown-search-container">
                      <input type="text" class="form-control" placeholder="Type to filter..." id="searchInput"
                    ...
                    <!-- Filterable Dropdown Items. Added some text to demonstrate search functionality -->
                    <li><a class="dropdown-item" href="#">1 (Option Alpha)</a></li>
                    <li><a class="dropdown-item" href="#">2 (Option Beta)</a></li>
                    <li><a class="dropdown-item" href="#">3 (Option Gamma)</a></li>
                    <li><a class="dropdown-item" href="#">4 (Option Delta)</a></li>
                    <li><a class="dropdown-item" href="#">5 (Option Epsilon)</a></li>
                    <li><a class="dropdown-item" href="#">6 (Extra option to demonstrate scrolling)</a></li>
                    <li><a class="dropdown-item" href="#">7 (Another extra option)</a></li>
                    <li><a class="dropdown-item" href="#">8 (Last extra option)</a></li>
                  </ul>
                </div>
              </div>

              <!-- Example Multiple Select (from user's code) - Converted to Bootstrap 5 classes -->
              <div class="mb-3">
                <label for="exampleFormControlSelect2" class="form-label">Example multiple select</label>
                <select multiple class="form-select" id="exampleFormControlSelect2" size="4">
                  <option>1</option>
                  <option>2</option>
                  <option>3</option>
                  <option>4</option>

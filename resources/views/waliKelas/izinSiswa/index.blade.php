                    ...
                    <td class="align-middle text-sm">
                      @if($izin->status_id == 1)
                        <div class="d-flex align-items-center gap-1">
                          <form action="{{ route('izin-siswaByWaliKelas.update_status', ['izinSiswa' => $izin->id, 'statusId' => 2]) }}"
                            method="POST">
                            @csrf
                            <!-- Approve Button -->
                            <button type="button"
                          ...
                          <form action="{{ route('izin-siswaByWaliKelas.update_status', ['izinSiswa' => $izin->id, 'statusId' => 4]) }}"
                            method="POST">
                            @csrf
                            <button type="button"

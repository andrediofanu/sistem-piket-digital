            ...
            <div class="col-8">
              <div class="numbers">
                ...
                <h5 class="font-weight-bolder mb-0">
                  {{ $countStatus1Guru + $countStatus2 }}
                  <br>
                  <span class="text-secondary text-sm font-weight-bold">Guru: {{ $countStatus1Guru }}</span>

                  <span class="text-secondary text-sm font-weight-bold">Siswa: {{$countStatus2}}</span>
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Jumlah Siswa Tidak Masuk Hari Ini</p>
                <h5 class="font-weight-bolder mb-0">
                  {{ $todayCount }}
                  <br>
                  <span class="text-secondary text-sm font-weight-bold">Sakit: {{ $todayCountSiswaSakit }}</span>

                  <span class="text-secondary text-sm font-weight-bold">Izin: {{ $todayCountSiswaIzin }}</span>

                  <span class="text-secondary text-sm font-weight-bold">Alpha: {{ $todayCountSiswaAlpha }}</span>
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold">Jumlah Guru Tidak Masuk Hari Ini</p>
                <h5 class="font-weight-bolder mb-0">
                  {{ $todayCountGuru }}
                  <br>
                  <span class="text-secondary text-sm font-weight-bold">Sakit: {{ $todayCountGuruSakit }}</span>

                  <span class="text-secondary text-sm font-weight-bold">Izin: {{ $todayCountGuruIzin}}</span>

                  <span class="text-secondary text-sm font-weight-bold">Alpha: {{ $todayCountGuruAlpha }}</span>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="d-flex flex-column h-100">
                <p class="mb-1 pt-2 text-bold">Card</p>
                <h5 class="font-weight-bolder">Container</h5>
                <p class="mb-5">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Assumenda libero perferendis
                  soluta? Sit ab tenetur minus adipisci quasi omnis inventore doloribus sapiente quia aliquam voluptatibus
                  architecto, officia cupiditate corporis numquam.</p>

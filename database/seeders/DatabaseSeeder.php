...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $kelasData = [
            ...
            ['id' => 21, 'name' => 'XI-J', 'wali_kelas_id' => 61],
        ...
        $mapelData = [
            ...
            ['id' => 18, 'name' => 'PKn/PPKn'],
            ['id' => 19, 'name' => 'PKWU'],
            ['id' => 20, 'name' => 'Qawaidul Arabiyah'],
            ['id' => 21, 'name' => 'Sejarah'],
            ['id' => 22, 'name' => 'Sejarah Indonesia'],
            ['id' => 23, 'name' => 'Seni Budaya'],
            ['id' => 24, 'name' => 'SKI'],
            ['id' => 25, 'name' => 'Sosiologi'],
            ['id' => 26, 'name' => 'Tafsir'],
            ['id' => 27, 'name' => 'Ushul Fiqih'],
        ];
